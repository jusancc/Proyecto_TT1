...
int main() {
    ...
    for (int i = 1; i <= num_obs; i++) {
        ...
        strncpy(temp, &buffer[0], 4); temp[4] = '\0'; double YY = atof(temp);
        strncpy(temp, &buffer[5], 2); temp[2] = '\0'; double MM = atof(temp);
        strncpy(temp, &buffer[8], 2); temp[2] = '\0'; double DD = atof(temp);
        strncpy(temp, &buffer[12], 2); temp[2] = '\0'; double hh = atof(temp);
        strncpy(temp, &buffer[15], 2); temp[2] = '\0'; double mm = atof(temp);
        strncpy(temp, &buffer[18], 6); temp[6] = '\0'; double ss = atof(temp);
        strncpy(temp, &buffer[25], 8); temp[8] = '\0'; double az = atof(temp);
        strncpy(temp, &buffer[35], 7); temp[7] = '\0'; double el = atof(temp);
        strncpy(temp, &buffer[44], 10); temp[10] = '\0'; double dist = atof(temp);
